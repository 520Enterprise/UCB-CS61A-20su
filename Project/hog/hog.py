...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    return abs(player_score % 10 - opponent_score % 10) == (opponent_score % 100) // 10
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while True:
        ...
        if who == 0:
            ...
            if abs(num_rolls - last0) == 2:
                flag = True
            last0 = take_turn(num_rolls, score1, dice)
            score0 += last0
            if feral_hogs:
                if flag:
                    score0 += 3
            ...
            if abs(num_rolls - last1) == 2:
                flag = True
            last1 = take_turn(num_rolls, score0, dice)
            score1 += last1
            if feral_hogs:
                if flag:
                    score1 += 3
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if score - last_score > running_high:
            running_high_new = score - last_score
            print(running_high_new, "point(s)! That's the biggest gain yet for Player", who)
        else:
            running_high_new = running_high
        print("DEBUG:", score, last_score, running_high_new)
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if is_swap(score1, opponent_score):
        print("DEBUG:", score, opponent_score)
        if opponent_score - score1 > 0:
            return 0
        elif opponent_score - score1 < 0:
            return num_rolls
