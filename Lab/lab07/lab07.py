...
def trade(first, second):
    ...
    equal_prefix = lambda: first[:m] == second[:n]
...
def make_glookup(class_assignments):
    ...
    def glookup(key, value):
        nonlocal theory_total, actual_total
        theory_total += class_assignments[key]
        actual_total += value
        return actual_total / theory_total
